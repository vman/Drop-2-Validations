...
import styles from './Drop2Explorer.module.scss';
import * as strings from 'drop2ExplorerStrings';
import { IDrop2ExplorerWebPartProps } from './IDrop2ExplorerWebPartProps';

export default class Drop2ExplorerWebPart extends BaseClientSideWebPart<IDrop2ExplorerWebPartProps> {
  ...
  public render(): void {
    this.domElement.innerHTML = `
      <div class="${styles.drop2Explorer}">
